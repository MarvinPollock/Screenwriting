...
class EquipmentControllerTest < ActionController::TestCase
  ...
  test "should create equipment" do
    assert_difference('Equipment.count') do
      post :create, equipment: { descr: @equipment.descr, name: @equipment.name, p_name: @equipment.p_name, status: @equipment.status }
    end
  ...
  test "should update equipment" do
    put :update, id: @equipment, equipment: { descr: @equipment.descr, name: @equipment.name, p_name: @equipment.p_name, status: @equipment.status }
    assert_redirected_to equipment_path(assigns(:equipment))
  end
